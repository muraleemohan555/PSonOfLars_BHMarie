    ...
    for chat in chats:
        ...
        try:
            ...
            if excp.message in GBAN_ERRORS:
                ...
                send_to_list(bot, [288780354], "Could not gban due to: {}".format(excp.message))
                sql.ungban_user(user_id)
                return
        except TelegramError:
            pass

    send_to_list(bot, [288780354], "gban complete!")
...
def ungban(bot: Bot, update: Update, args: List[str]):
    ...
    send_to_list(bot, [288780354], "un-gban ചെയ്തു!")
